...
import 'package:LASYLAB/feature/courses/presentation/page/quiz_answer.dart';
...
final routes = {
  ...
  VideoCourseReading.routeName: (BuildContext context) => VideoCourseReading(),
  "/course_reader": (BuildContext context) => CourseReader(),
  "/quiz_launcher": (BuildContext context) => QuizLauncher(),
  QuizTestWidget.routeName: (BuildContext context) => QuizTestWidget(),
  ...
  FormationScreen.routeName: (BuildContext context) => FormationScreen()
};
